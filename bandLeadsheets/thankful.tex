...
\begin{tabular}{p{1.6cm}l}
    ...
    \textbf{Vers 2} & Kick 1, Snare auf 4, lässiger Beat auf Ride \\
    % \textbf{Vers 2} & HH 1/16, Kick 1, 2a, 3, 3+, Snare auf 4, damit lässiger Beat \\
    \textbf{Chorus} & Kick 1, 2a, 3                            \\
                    & ab Mitte Gustav                          \\
    \textbf{Zw}     & nur ein Takt, dann Bridge \\
    \textbf{Bridge} & Kick 1, 3, 3+, Backbeat                  \\
                    & runter mit \textit{my oh my}          \\
                    & später wieder einsteigen              \\
    \textbf{Chorus} & ruhig rein \\
                    & mit fill rein auf \textit{Thank you for the laughter} \\
    \textbf{Ende }  & runter auf \textit{life}                                    \\
                    &                                          \\
\end{tabular}
