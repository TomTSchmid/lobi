...
\begin{tabular}{p{1.6cm}l}
	% \textbf{Start}  & ruhig Bridge                                        \\ % Lobpreisabend 28,04.24
	% \textbf{Chorus} & mehrfach wiederholen, ruhig bleiben \\ % Lobpreisabend 28,04.24
	...
	\textbf{Vers 2} & wie Intro                                           \\
	                & alternativ: keine HH, nur mit Ghost Notes auf Snare \\
	\textbf{Chorus} & Kick 1, 3, 3+, Backbeat, vielleicht Snare auf 2a    \\
	\textbf{Bridge} & 2x wie Ch, danach direkt in Ch                         \\
