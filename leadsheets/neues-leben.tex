...
\begin{tabular}{p{1.6cm}l}
	...
	\textbf{Intro}  & Kick 1, 1a, 3, 3a mit HH                             \\
...
% -------------------- Spezialversion für Taufe ----------------------------------------
	% \textbf{Chorus} & Gustav oder 4f, HH tänzeln                     \\
	% \textbf{Bridge} & Kick 1, 3, Snare 1, 1+, 1a, 2+                                                          \\
	% 				& oder bissle anders weil langsamer \\
	%                 & Lange steigern                                                                          \\
	% \textbf{Chorus} & ruhig, ganz am Ende bissle aufbauen, aber dann Ende                                                        \\
	                &                                                                                         \\
\end{tabular}
