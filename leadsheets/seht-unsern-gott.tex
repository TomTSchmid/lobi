...
\begin{tabular}{p{1.6cm}l}
    ...
    \textbf{Bridge} & Bridge von Gotteslamm, ab hier satt steigern \\
                    & erstes Mal Kick 2, 4 \\
                    & zweites Mal Toms dazu \\
                    & dann fetter Beat \\
    % \textbf{Zw}     & nix                                             \\
    % \textbf{Vers 2} & rein mit Beat mit voller Snare                  \\
    % \textbf{Chorus} & voller Beat auf HH                              \\
    % \textbf{Zw}     & voller Beat auf Ride weiter                     \\
    % \textbf{Vers 3} & ab Start ruhig                                  \\
    %                 & ab Mitte wieder mit Beat rein                   \\
    % \textbf{Chorus} & voller Beat auf HH                              \\
    %                 & direkt ab Textende ruhig                        \\
    % \textbf{Bridge} & Snarewirbel, insgesamt nur 2x                                     \\
    %                 & nach 2x Mal Beat auf Ride, nochmal 4x           \\
